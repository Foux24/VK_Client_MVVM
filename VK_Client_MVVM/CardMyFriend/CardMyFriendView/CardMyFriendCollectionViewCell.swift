//
//  CardMyFriendCollectionViewCell.swift
//  VK_Client_MVVM
//
...
final class CardMyFriendCollectionViewCell: UICollectionViewCell {
    
    /// Ключ для регистрации ячкйки
    static let reuseID = String(describing: CardMyFriendCollectionViewCell.self)
...
// MARK: - Private
private extension CardMyFriendCollectionViewCell {
